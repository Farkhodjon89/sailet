...
const HeroCard = ({ name, img, setColored, id, text}) => {
  ...
  return (
      <li className={s.card}>
        ...
        <div className={s.heroItem} onMouseEnter={() => setColored(id)}
          ...
          {activeCard &&
          <HeroItem id={id} name={name} text={text} img={img} hero={activeCard} setHero={setActiveCard}/>}
        </div>
      </li>
  );
};
